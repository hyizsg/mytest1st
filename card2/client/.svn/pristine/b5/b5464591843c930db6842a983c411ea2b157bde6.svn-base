...
if [[ "$buildexternalsfromsource" ]]; then
    ...
    "$NDK_ROOT"/ndk-build -C "$APP_ANDROID_ROOT" $* -j$CPU\
...
cp $APP_ANDROID_ROOT/../../Resources/AndroidLibs/*.so $APP_ANDROID_ROOT/libs/armeabi/
cp $APP_ANDROID_ROOT/../../Resources/AndroidLibs/gameframework.jar $APP_ANDROID_ROOT/libs/
